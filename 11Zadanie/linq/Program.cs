...
class Program
{
    static void Main(string[] args)
    {
        ...
        Enclosure enclosure1 = new Enclosure(1, "Large", 5);
        Enclosure enclosure2 = new Enclosure(2, "Medium", 3);
        Enclosure enclosure3 = new Enclosure(3, "Small", 2);
        Enclosure enclosure4 = new Enclosure(4, "Medium", 4);
        ...
        if (response.ToLower() == "y")
        {
            ...
            {
                var enclosure = zoo.Enclosures.FirstOrDefault(e => e.Number == enclosureNumber);
                if (enclosure != null)
                {
